...
# save_directory = '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_phi_2/'
# save_directory = '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_phi_2_whitespace_no_bos_base'
save_directory = '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_phi_2_whitespace'
...
def main():
    ...
    # torch.save(intervention_list, os.path.join(save_directory, 'intervention_list.pkl'))
    intervention_list = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_phi_2_old/intervention_list.pkl')
    ...
    for item in intervention_list:
        ...
        assert input_id_base.shape == input_id_alt.shape
        # input_id_base, input_id_alt = tokenize(item, tokenizer)
        
        # print('#' * 100)
        # print('Input base')
        # for token in input_id_base.squeeze().cpu().numpy().tolist():
        #     print(tokenizer.decode(token))
        # print('Input alt')
        # for token in input_id_alt.squeeze().cpu().numpy().tolist():
        #     print(tokenizer.decode(token))
    ...
    plt.ylabel('Layer')
    plt.savefig(os.path.join(save_directory, 'patching_mlp.png'))
