...
def main():
    ...
    # torch.save(all_resid_pre_act_patch_results, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/resid_pre_logit_diff.pkl')
    # torch.save(all_resid_pre_clean_logit_diffs, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/clean_diff.pkl')
    # torch.save(all_resid_pre_corrupted_logit_diffs, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/corrupted_logit_diff.pkl')
    all_resid_pre_act_patch_results = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/resid_pre_logit_diff.pkl')
    all_resid_pre_clean_logit_diffs = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/clean_diff.pkl')
    all_resid_pre_corrupted_logit_diffs = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/corrupted_logit_diff.pkl')
    ...
    torch.save(patching_effect.T, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/patching_effect_residual_stream.pkl')
    plt.figure()
    sns.heatmap(
        patching_effect.T,
        cmap='RdBu',
    ...
    plt.ylabel('Layer')
    plt.savefig('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/plot_figures/patching_residual_stream_original_data_transposed.png')
    ...
    # torch.save(attn_layer_act_patch_results, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/attn_layer_logit_diff.pkl')
    # torch.save(attn_layer_clean_logit_diffs, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/attn_layer_clean_logit_diff.pkl')
    # torch.save(attn_layer_corrupted_logit_diffs, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/attn_layer_corrupted_logit_diff.pkl')
    attn_layer_act_patch_results = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/attn_layer_logit_diff.pkl')
    attn_layer_clean_logit_diffs = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/attn_layer_clean_logit_diff.pkl')
    attn_layer_corrupted_logit_diffs = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/attn_layer_corrupted_logit_diff.pkl')
    ...
    torch.save(patching_effect.T, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/patching_effect_attn_layer.pkl')
    plt.figure()
    sns.heatmap(
        patching_effect.T,
        cmap='RdBu',
    ...
    plt.ylabel('Layer')
    plt.savefig('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/plot_figures/patching_attention_layer_original_data_transposed.png')
    ...
    # torch.save(mlp_act_patch_results, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/mlp_logit_diff.pkl')
    # torch.save(mlp_clean_logit_diffs, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/mlp_clean_logit_diff.pkl')
    # torch.save(mlp_corrupted_logit_diffs, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/mlp_corrupted_logit_diff.pkl')
    mlp_act_patch_results = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/mlp_logit_diff.pkl')
    mlp_clean_logit_diffs = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/mlp_clean_logit_diff.pkl')
    mlp_corrupted_logit_diffs = torch.load('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/mlp_corrupted_logit_diff.pkl')
    ...
    torch.save(patching_effect.T, '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_original_dataset_pythia_12b/patching_effect_mlp.pkl')
    plt.figure()
    sns.heatmap(
        patching_effect.T,
        cmap='RdBu',
    ...
    plt.ylabel('Layer')
    plt.savefig('/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/plot_figures/patching_mlp_original_data_transposed.png')
