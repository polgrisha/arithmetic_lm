...
# save_directory = '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_opt_6_7b/'
save_directory = '/mnt/qb/work/eickhoff/esx208/arithmetic-lm/data/patching_results_opt_6_7b_whitespace_no_bos_base'
...
def main():
    ...
    # intervention_list = torch.load(os.path.join(save_directory, 'intervention_list.pkl'))
