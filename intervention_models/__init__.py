class BaseModel:
    def __init__(self, model_version):
        ...
        self.is_gptneo = model_version.startswith('EleutherAI/gpt-neo') and not self.is_neox
        ...
        self.is_mistral = model_version.startswith('mistralai')
        self.is_qwen = model_version.startswith('Qwen')
        self.is_bloom = model_version.startswith('bigscience/bloom')
        self.is_persimmon = model_version.startswith('persimmon')
        self.is_mpt = model_version.startswith("mosaicml")
